(function () {
  ...
  function toggleNavCollapsedMin($rootScope) {
    ...
    function link(scope, ele, attrs) {
      ...
      ele.on('click', function (e) {
        ...
        scope.menuCollapsed = app.hasClass('nav-collapsed-min');
  ...
  function highlightActive() {
    var directive = {
      restrict: 'A',
      controller: ['$scope', '$element', '$attrs', '$location', 'permissions', highlightActiveCtrl]
    };

    return directive;

    function highlightActiveCtrl($scope, $element, $attrs, $location, permissions) {
